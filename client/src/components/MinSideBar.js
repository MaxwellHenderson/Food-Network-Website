...
class MinSideBar extends Component {
    render() {
        return (
            // <div id="sidebar" class="sidebar" style={{width: '80px', 'margin-top': '0px', 'background-color':'#393D3F', height: '95vh', position: 'fixed', right: '0px'}}>
            <div id="sidebar" className="sidebar mr-0 h-100" style={{width: '80px', 'margin-top': '0px', 'background-color':'#393D3F', position: 'fixed', right: '0px'}}>
                <div id="sidebar-header" class="py-3" style={{color: 'white', height: '130px', 'background-color': '#282A2C'}} >
                    <div id="user_info" class="row ml-0 mr-0">
                        <img src="imgs/profile_default.jpg" class="rounded-circle my-1 column" style={{height: '50px'}} alt="profile picture"/>
                ...
                <div id="sidebar-list" class="container px-0 listings" style={{color: 'white'}}>
                    ...
                    <div id="sidebar-buttons" class="row mx-0 border-top" style={{'font-size': '14px', position: 'absolute', bottom: 0}} >
                        <div class="column px-2 py-2 border-right">
                            <i class="fas fa-plus"></i>
                        </div>
                        {/* <div class="column px-4 py-2 border-right" >
                            <i class="far fa-grin-beam-sweat"></i>
                        </div> */}
                        <div class="column px-2 py-2" >
